...
📄 Included
- **[homelab-setup.pdf](./machine-setup/homelab-setup.pdf)**  – Full walkthrough covering installation, user setup, SSH configuration, remote access via Eero, and hardening tips.
