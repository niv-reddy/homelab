...
| [AD Lab/](./enterprise-ad-lab/) | Enterprise Identity & Security Platform:<br>- Immutable AD forest root of trust (lab.niv.local)<br>- Tiered admin model (Tier 0/1/2) with OU & security group control planes<br>- Segmented trust zones (Servers / Workstations / Security)<br>- Hardened domain baselines (GPO, LAPS, access restrictions)<br>- SIEM-ready logging & detection engineering (Wazuh)<br>- Adversary emulation & blue-team simulation framework<br>- Snapshot-anchored recovery & reproducible build layers |
